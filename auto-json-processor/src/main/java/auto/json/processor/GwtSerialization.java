...
/**
 * Generates GWT serialization code for {@code @AutoJson} classes also marked
...
class GwtSerialization {
  ...
  /**
   * Writes the GWT serializer for the given type, if appropriate. An {@code @AutoJson} class gets
   ...
   *
   * <p>If the type is com.example.Foo then the generated AutoJson subclass is
   * com.example.AutoJson_Foo and the GWT serializer is
   * com.example.AutoJson_Foo_CustomFieldSerializer.
   *
   * @param autoVars the template variables defined for this type.
   */
  void maybeWriteGwtSerializer(AutoJsonTemplateVars autoVars) {
    if (shouldWriteGwtSerializer()) {
      ...
      for (AutoJsonProcessor.Property prop : autoVars.props) {
  ...
  public static class Property {
    private final AutoJsonProcessor.Property property;
  ...
  static class GwtTemplateVars extends TemplateVars {
    ...
    /**
     * The package of the class with the {@code @AutoJson} annotation and its generated subclass.
     */
    String pkg;
  ...
  private String computeClassHash(List<AutoJsonProcessor.Property> props) {
    ...
    for (AutoJsonProcessor.Property prop : props) {
