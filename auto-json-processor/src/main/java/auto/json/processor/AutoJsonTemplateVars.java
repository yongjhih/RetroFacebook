...
/**
 * The variables to substitute into the autojson.vm template.
 *
 * @author emcmanus@google.com (Éamonn McManus)
 */
@SuppressWarnings("unused")  // the fields in this class are only read via reflection
class AutoJsonTemplateVars extends TemplateVars {
  ...
  String pkg;
  /**
   * The name of the class with the {@code @AutoJson} annotation, including containing
   * classes but not including the package name.
   */
  String origClass;
  /** The simple name of the class with the {@code @AutoJson} annotation. */
  String simpleClassName;
  /** The simple name of the generated subclass. */
  String subclass;

  /**
   * The formal generic signature of the class with the {@code @AutoJson} annotation and its
   ...
   * builder type. If class {@code Address} contains {@code @AutoJson.Builder} class Builder
   * then this will typically be {@code "Address.Builder"}.
   */
  String builderTypeName = "";

  /**
   * The formal generic signature of the {@code AutoJson.Builder} class. This is empty, or contains
  ...
  private static final SimpleNode TEMPLATE = parsedTemplateForResource("autojson.vm");
