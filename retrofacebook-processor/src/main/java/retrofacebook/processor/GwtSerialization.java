...
/**
 * Generates GWT serialization code for {@code @RetroFacebook} classes also marked
...
class GwtSerialization {
  ...
  /**
   * Writes the GWT serializer for the given type, if appropriate. An {@code @RetroFacebook} class gets
   ...
   *
   * <p>If the type is com.example.Foo then the generated RetroFacebook subclass is
   * com.example.RetroFacebook_Foo and the GWT serializer is
   * com.example.RetroFacebook_Foo_CustomFieldSerializer.
   *
   * @param autoVars the template variables defined for this type.
   */
  void maybeWriteGwtSerializer(RetroFacebookTemplateVars autoVars) {
    if (shouldWriteGwtSerializer()) {
      ...
      for (RetroFacebookProcessor.Property prop : autoVars.props) {
  ...
  public static class Property {
    private final RetroFacebookProcessor.Property property;
    private final boolean isCastingUnchecked;

    Property(RetroFacebookProcessor.Property property) {
  ...
  private String computeClassHash(List<RetroFacebookProcessor.Property> props) {
    ...
    for (RetroFacebookProcessor.Property prop : props) {
