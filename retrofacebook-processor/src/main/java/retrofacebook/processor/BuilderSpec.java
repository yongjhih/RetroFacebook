...
/**
 * Support for RetroFacebook builders.
 *
...
class BuilderSpec {
  ...
  /**
   * Representation of an {@code RetroFacebook.Builder} class or interface.
   */
  class Builder {
    ...
    void defineVars(
        RetroFacebookTemplateVars vars,
  ...
  /**
   * Returns a representation of the given {@code @RetroFacebook.Builder} class or interface. If the
  ...
  private Optional<Builder> builderFrom(
    ...
    // We require the builder to have the same type parameters as the @RetroFacebook class, meaning the
    ...
    // builderTypeElement. A build method has no arguments and returns the @RetroFacebook class.
