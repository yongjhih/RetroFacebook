...
import retrofacebook.processor.RetroFacebookBuilderProcessor;
import retrofacebook.processor.RetroFacebookProcessor;
...
public class CompilationTest extends TestCase {
  public void testCompilation() {
    ...
    // Most RetroFacebook code-generation tests are functional, meaning that we check that the generated
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.RetroFacebook_Baz",
        "package foo.bar;",
        "",
        "final class RetroFacebook_Baz extends Baz {",
        "  private final int buh;",
        "",
        "  RetroFacebook_Baz(int buh) {",
        "    this.buh = buh;",
        "  }",
        "",
  ...
  public void testImports() {
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroFacebook_Baz(ints, arrays);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.RetroFacebook_Baz",
        ...
        "",
        "  RetroFacebook_Baz(int[] ints, Arrays arrays) {",
        "    if (ints == null) {",
        ...
        "    if (o instanceof Baz) {",
        "      Baz that = (Baz) o;",
        "      return (Arrays.equals(this.ints, (that instanceof RetroFacebook_Baz) "
                      + "? ((RetroFacebook_Baz) that).ints : that.ints()))",
  ...
  public void testNoObjectArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroFacebook_Baz(strings);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
  ...
  public void testExtendRetroFacebook() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Outer",
        "package foo.bar;",
        "",
        ...
        "      return new RetroFacebook_Outer_Parent(randomProperty);",
        "    }",
        "",
        ...
        "      return new RetroFacebook_Outer_Child(randomProperty);",
        "    }",
        "",
        "    abstract int randomProperty();",
        "  }",
  ...
  public void testNonExistentSuperclass() throws Exception {
    // The main purpose of this test is to check that RetroFacebookProcessor doesn't crash the
  ...
  public void testCannotImplementAnnotation() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroFacebook_RetentionImpl(policy);",
        "  }",
        "",
  ...
  public void testCorrectBuilder() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return RetroFacebook_Baz.builder();",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.RetroFacebook_Baz",
        ...
        "          && (Arrays.equals(this.aByteArray, "
                    + "(that instanceof RetroFacebook_Baz) "
                        + "? ((RetroFacebook_Baz) that).aByteArray : that.aByteArray()))",
        "          && (Arrays.equals(this.aNullableIntArray, "
                    + "(that instanceof RetroFacebook_Baz) "
                        + "? ((RetroFacebook_Baz) that).aNullableIntArray : that.aNullableIntArray()))",
        ...
        "      }",
        "      Baz<T> result = new RetroFacebook_Baz<T>(",
  ...
  public void testRetroFacebookBuilderNotInsideRetroFacebook() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
        ...
        "    return new RetroFacebook_Baz.Builder();",
        "  }",
        "",
        "  @RetroFacebook.Builder",
        "  public interface Builder {",
  ...
  public void testRetroFacebookBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderMissingSetterUsingSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderWrongTypeSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderExtraSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderSetPrefixAndNoSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderAlienMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderMissingBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderWrongTypeBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderTypeParametersDontMatch1() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderTypeParametersDontMatch2() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderTypeParametersDontMatch3() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderToBuilderWrongTypeParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderToBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroFacebookBuilderValidateMethodStatic() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroFacebookProcessor(), new RetroFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@RetroFacebook.Validate cannot apply to a static method")
        .in(javaFileObject).onLine(10);
  }
  ...
  public void testRetroFacebookBuilderValidateMethodWithParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroFacebookProcessor(), new RetroFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@RetroFacebook.Validate method must not have parameters")
        .in(javaFileObject).onLine(10);
  }

  public void testRetroFacebookBuilderValidateMethodDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroFacebookProcessor(), new RetroFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("There can only be one @RetroFacebook.Validate method")
        .in(javaFileObject).onLine(13);
  }
  ...
  public void testGetFooIsFoo() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroFacebookProcessor())
        .failsToCompile()
        .withErrorContaining("More than one @RetroFacebook property called foo")
        .in(javaFileObject).onLine(8);
  }

  private static class PoisonedRetroFacebookProcessor extends RetroFacebookProcessor {
    private final IllegalArgumentException filerException;

    PoisonedRetroFacebookProcessor(IllegalArgumentException filerException) {
  ...
  public void testReferencingGeneratedClass() {
    // Test that ensures that a type that does not exist can be the type of an @RetroFacebook property
    // as long as it later does come into existence. The BarFoo type referenced here does not exist
    // when the RetroFacebookProcessor runs on the first round, but the FooProcessor then generates it.
    // That generation provokes a further round of annotation processing and RetroFacebookProcessor
    // should succeed then.
    JavaFileObject bazFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroFacebook_Baz(barFoo);",
        "  }",
        "}");
    ...
    assertAbout(javaSources())
        ...
        .processedWith(new RetroFacebookProcessor(), new FooProcessor())
        .compilesWithoutError();
  }
}
