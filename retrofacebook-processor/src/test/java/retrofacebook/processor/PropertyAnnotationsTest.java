...
/**
 * Tests to ensure annotations are kept on RetroFacebook generated classes
 *
 * @author jmcampanini
 */
public class PropertyAnnotationsTest extends TestCase {
  ...
  private static final String PROPERTY_ANNOTATION_TEST =
      "retrofacebook.processor.PropertyAnnotationsTest";
  private static final String TEST_ANNOTATION =
      "@retrofacebook.processor.PropertyAnnotationsTest.TestAnnotation";
  ...
  private JavaFileObject expectedCode(List<String> annotations) {
    ...
    String[] lines = list.toArray(new String[list.size()]);
    return JavaFileObjects.forSourceLines("foo.bar.RetroFacebook_Baz", lines);
  }
