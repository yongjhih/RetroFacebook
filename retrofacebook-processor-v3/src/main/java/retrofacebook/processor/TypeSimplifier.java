...
final class TypeSimplifier {
   ...
   * the package containing the RetroFacebook class, provided that the result refers to the type
  ...
  // If we have @RetroFacebook abstract class Foo<T extends SomeClass> then this method will
  ...
  // If we have @RetroFacebook abstract class Foo<T extends Something> then the subclass will be
  // final class RetroFacebook_Foo<T extends Something> extends Foo<T>.
