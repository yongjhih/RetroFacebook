...
final class TypeSimplifier {
   ...
   * the package containing the AutoFacebook class, provided that the result refers to the type
  ...
  // If we have @AutoFacebook abstract class Foo<T extends SomeClass> then this method will
  ...
  // If we have @AutoFacebook abstract class Foo<T extends Something> then the subclass will be
  // final class AutoFacebook_Foo<T extends Something> extends Foo<T>.
