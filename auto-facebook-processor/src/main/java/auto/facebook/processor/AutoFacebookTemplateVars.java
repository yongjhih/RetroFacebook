...
/**
 * The variables to substitute into the autofacebook.vm template.
 *
 * @author emcmanus@google.com (Éamonn McManus)
 */
@SuppressWarnings("unused")  // the fields in this class are only read via reflection
class AutoFacebookTemplateVars extends TemplateVars {

  private static final String templateStr =
      "## Template for each generated AutoFacebook_Foo class.\n" +
              "## This template uses the Apache Velocity Template Language (VTL).\n" +
              "## The variables ($pkg, $props, and so on) are defined by the fields of AutoFacebookTemplateVars.\n" +
              "##\n" +
  ...
  List<AutoFacebookProcessor.Property> props;
  ...
  /**
   * The package of the class with the {@code @AutoFacebook} annotation and its generated subclass.
   */
  String pkg;
  /**
   * The name of the class with the {@code @AutoFacebook} annotation, including containing
   * classes but not including the package name.
   */
  String origClass;
  /** The simple name of the class with the {@code @AutoFacebook} annotation. */
  String simpleClassName;
  /** The simple name of the generated subclass. */
  String subclass;

  /**
   * The formal generic signature of the class with the {@code @AutoFacebook} annotation and its
   ...
   * builder type. If class {@code Address} contains {@code @AutoFacebook.Builder} class Builder
   * then this will typically be {@code "Address.Builder"}.
   */
  String builderTypeName = "";

  /**
   * The formal generic signature of the {@code AutoFacebook.Builder} class. This is empty, or contains
  ...
  /**
   * The simple names of validation methods (marked {@code @AutoFacebook.Validate}) in the AutoFacebook
   * class. (Currently, this set is either empty or a singleton.)
   */
  Set<String> validators = Collections.emptySet();

  private static final SimpleNode TEMPLATE = parsedTemplateForResource(templateStr, "autofacebook.vm");
