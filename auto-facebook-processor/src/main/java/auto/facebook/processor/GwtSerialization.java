...
/**
 * Generates GWT serialization code for {@code @AutoFacebook} classes also marked
...
class GwtSerialization {
  ...
  /**
   * Writes the GWT serializer for the given type, if appropriate. An {@code @AutoFacebook} class gets
   ...
   *
   * <p>If the type is com.example.Foo then the generated AutoFacebook subclass is
   * com.example.AutoFacebook_Foo and the GWT serializer is
   * com.example.AutoFacebook_Foo_CustomFieldSerializer.
   *
   * @param autoVars the template variables defined for this type.
   */
  void maybeWriteGwtSerializer(AutoFacebookTemplateVars autoVars) {
    if (shouldWriteGwtSerializer()) {
      ...
      for (AutoFacebookProcessor.Property prop : autoVars.props) {
  ...
  public static class Property {
    private final AutoFacebookProcessor.Property property;
    private final boolean isCastingUnchecked;

    Property(AutoFacebookProcessor.Property property) {
  ...
  private String computeClassHash(List<AutoFacebookProcessor.Property> props) {
    ...
    for (AutoFacebookProcessor.Property prop : props) {
