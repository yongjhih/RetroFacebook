 ...
 */
package auto.facebook.processor;
...
import auto.facebook.processor.AutoFacebookBuilderProcessor;
import auto.facebook.processor.AutoFacebookProcessor;
...
public class CompilationTest extends TestCase {
  public void testCompilation() {
    ...
    // Most AutoFacebook code-generation tests are functional, meaning that we check that the generated
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_Baz(buh);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoFacebook_Baz",
        "package foo.bar;",
        "",
        "final class AutoFacebook_Baz extends Baz {",
        "  private final int buh;",
        "",
        "  AutoFacebook_Baz(int buh) {",
        "    this.buh = buh;",
        "  }",
        "",
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoFacebookProcessor())
  ...
  public void testImports() {
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_Baz(ints, arrays);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoFacebook_Baz",
        ...
        "",
        "  AutoFacebook_Baz(int[] ints, Arrays arrays) {",
        "    if (ints == null) {",
        ...
        "    if (o instanceof Baz) {",
        "      Baz that = (Baz) o;",
        "      return (Arrays.equals(this.ints, (that instanceof AutoFacebook_Baz) "
                      + "? ((AutoFacebook_Baz) that).ints : that.ints()))",
  ...
  public void testNoMultidimensionalPrimitiveArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_Baz(ints);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoFacebookProcessor())
        .failsToCompile()
        .withErrorContaining("AutoFacebook class cannot define an array-valued property "
  ...
  public void testNoObjectArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_Baz(strings);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
  ...
  public void testAnnotationOnInterface() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor())
        .failsToCompile()
        .withErrorContaining("AutoFacebook only applies to classes")
  ...
  public void testExtendAutoFacebook() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Outer",
        "package foo.bar;",
        "",
        ...
        "      return new AutoFacebook_Outer_Parent(randomProperty);",
        "    }",
        "",
        ...
        "      return new AutoFacebook_Outer_Child(randomProperty);",
        "    }",
        "",
        "    abstract int randomProperty();",
        "  }",
  ...
  public void testNonExistentSuperclass() throws Exception {
    // The main purpose of this test is to check that AutoFacebookProcessor doesn't crash the
  ...
  public void testCannotImplementAnnotation() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_RetentionImpl(policy);",
        "  }",
        "",
  ...
  public void testCorrectBuilder() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return AutoFacebook_Baz.builder();",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoFacebook_Baz",
        ...
        "          && (Arrays.equals(this.aByteArray, "
                    + "(that instanceof AutoFacebook_Baz) "
                        + "? ((AutoFacebook_Baz) that).aByteArray : that.aByteArray()))",
        "          && (Arrays.equals(this.aNullableIntArray, "
                    + "(that instanceof AutoFacebook_Baz) "
                        + "? ((AutoFacebook_Baz) that).aNullableIntArray : that.aNullableIntArray()))",
        ...
        "      }",
        "      Baz<T> result = new AutoFacebook_Baz<T>(",
  ...
  public void testAutoFacebookBuilderOnTopLevelClass() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Builder",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoFacebookProcessor(), new AutoFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("can only be applied to a class or interface inside")
        .in(javaFileObject).onLine(6);
  }

  public void testAutoFacebookBuilderNotInsideAutoFacebook() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
        ...
        "    return new AutoFacebook_Baz.Builder();",
        "  }",
        "",
        "  @AutoFacebook.Builder",
        "  public interface Builder {",
  ...
  public void testAutoFacebookBuilderOnEnum() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderMissingSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderMissingSetterUsingSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderWrongTypeSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderWrongTypeSetterWithGetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderExtraSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderSetPrefixAndNoSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderAlienMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderMissingBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderDuplicateBuildMethods() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderWrongTypeBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderTypeParametersDontMatch1() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderTypeParametersDontMatch2() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderTypeParametersDontMatch3() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderToBuilderWrongTypeParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookBuilderToBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoFacebookValidateNotInAutoFacebook() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining(
            "@AutoFacebook.Validate can only be applied to a method inside an @AutoFacebook class")
        .in(javaFileObject).onLine(9);
  }

  public void testAutoFacebookValidateWithoutBuilder() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining(
            "@AutoFacebook.Validate is only meaningful if there is an @AutoFacebook.Builder")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoFacebookBuilderValidateMethodStatic() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor(), new AutoFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoFacebook.Validate cannot apply to a static method")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoFacebookBuilderValidateMethodNotVoid() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor(), new AutoFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoFacebook.Validate method must be void")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoFacebookBuilderValidateMethodWithParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor(), new AutoFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoFacebook.Validate method must not have parameters")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoFacebookBuilderValidateMethodDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor(), new AutoFacebookBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("There can only be one @AutoFacebook.Validate method")
        .in(javaFileObject).onLine(13);
  }
  ...
  public void testGetFooIsFoo() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoFacebookProcessor())
        .failsToCompile()
        .withErrorContaining("More than one @AutoFacebook property called foo")
        .in(javaFileObject).onLine(8);
  }

  private static class PoisonedAutoFacebookProcessor extends AutoFacebookProcessor {
    private final IllegalArgumentException filerException;

    PoisonedAutoFacebookProcessor(IllegalArgumentException filerException) {
  ...
  public void testExceptionBecomesError() throws Exception {
    ...
    // AutoFacebookProcessor or javac.
    // We inject an exception by subclassing AutoFacebookProcessor in order to poison its processingEnv
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new PoisonedAutoFacebookProcessor(exception))
        .failsToCompile()
  ...
  public void testReferencingGeneratedClass() {
    // Test that ensures that a type that does not exist can be the type of an @AutoFacebook property
    // as long as it later does come into existence. The BarFoo type referenced here does not exist
    // when the AutoFacebookProcessor runs on the first round, but the FooProcessor then generates it.
    // That generation provokes a further round of annotation processing and AutoFacebookProcessor
    // should succeed then.
    JavaFileObject bazFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoFacebook_Baz(barFoo);",
        "  }",
        "}");
    ...
    assertAbout(javaSources())
        ...
        .processedWith(new AutoFacebookProcessor(), new FooProcessor())
        .compilesWithoutError();
  }
}
