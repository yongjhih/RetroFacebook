...
/**
 * Tests to ensure annotations are kept on AutoFacebook generated classes
 *
 * @author jmcampanini
 */
public class PropertyAnnotationsTest extends TestCase {
  ...
  private static final String PROPERTY_ANNOTATION_TEST =
      "auto.facebook.processor.PropertyAnnotationsTest";
  private static final String TEST_ANNOTATION =
      "@auto.facebook.processor.PropertyAnnotationsTest.TestAnnotation";
  ...
  private JavaFileObject expectedCode(List<String> annotations) {
    ...
    String[] lines = list.toArray(new String[list.size()]);
    return JavaFileObjects.forSourceLines("foo.bar.AutoFacebook_Baz", lines);
  }
