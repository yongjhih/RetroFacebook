...
public @interface AutoJson {
   ...
   * no-argument method in an AutoJson class. It will be called by the {@code build()} method of
   * the {@link Builder @AutoJson.Builder} implementation, immediately after constructing the new
